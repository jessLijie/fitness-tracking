...
class ExerciseBallWorkout extends StatefulWidget {
  ...
  @override
  State<ExerciseBallWorkout> createState() => _ExerciseBallWorkoutState();
}

class _ExerciseBallWorkoutState extends State<ExerciseBallWorkout> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('Exercise Ball Workout'),
          leading: IconButton(
        ...
        body: Column(
          children: [
            ...
            Center(
              child: Image.asset(
                widget.dumbbellWorkout[widget.currentIndex].gif,
                height: 250,
                width: 250,
              ),
            ),
            ...
            Text(
              widget.dumbbellWorkout[widget.currentIndex].name,
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      if (nextIndex < widget.dumbbellWorkout.length) {
                        Navigator.pushNamed(context, '/dumbbellWorkout',
                            arguments: {
                              'workouts': widget.dumbbellWorkout,
...
void sendCaloriesToFirebase(int totalCaloriesBurned) async {
  ...
  if (user != null) {
    Map<String, dynamic> userData =
        await _databaseService.getUserProfileData(user.uid);
    String uid = user.uid;
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text(
            'Are you sure you want to go back? You have burned ${totalCaloriesBurned} kcal.'),
            ...
            onPressed: () {
              ...
              Navigator.pushAndRemoveUntil(
                ...
                MaterialPageRoute(
                  ...
                  settings:
                      const RouteSettings(name: "Discover/dumbbellOverview"),
                ),
