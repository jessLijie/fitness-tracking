    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(
            '${timerProvider.getSeconds.toString()}:00',
            style: const TextStyle(
              fontSize: 45,
              fontWeight: FontWeight.bold,
            ),
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                sendCaloriesToFirebase(totalCaloriesBurned);
                // Provider.of<TimerProvider>(context, listen: false).exitTimer(); // Stop the timer and set seconds to 0
